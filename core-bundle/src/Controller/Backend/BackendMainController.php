...
class BackendMainController extends AbstractController
{
    ...
    private function getResponse(BackendTemplate $template): Response
    {
        ...
        // $backendThemes = $this->get(BackendThemes::class);

        //if ('flexible' !== Config::get('backendTheme') && null === $theme = $backendThemes->getTheme($themeName)) {
        // Legacy theme detected.
        //    return $template->getResponse();
        // }

        return $template->getResponse()->setContent(
            $this->get('twig')->render('@ContaoCore/Backend/Layout/main.html.twig', $template->getData())
        );
    }
    ...
    private function dashboard(): string
    {
        ...
        $return .= $this->fragmentHandler->render(new FragmentReference('contao.dashboard_widget.dashboard_gantt'));
        $return .= $this->fragmentHandler->render(new FragmentReference('contao.dashboard_widget.dashboard_create_wizard'));
        $return .= $this->fragmentHandler->render(new FragmentReference('contao.dashboard_widget.dashboard_heatmap'));
        $return .= $this->fragmentHandler->render(new FragmentReference('contao.dashboard_widget.dashboard_editions'));
        $return .= $this->fragmentHandler->render(new FragmentReference('contao.dashboard_widget.dashboard_actions'));
